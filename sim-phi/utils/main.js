...
(function () {
    ...
    Utils.loadJS('https://www.googletagmanager.com/gtag/js?id=G-K98WR056RJ').then(
        () => Utils.loadJS(`
...
Utils.lazyload(function () {
    ...
    // if (!(jct && jct[1] == 'ok' || document.referrer || isStandAlone)) return location.href = '/401.html';//去除验证
    ...
    for (const i of document.querySelectorAll('.info')) i.innerHTML =
        `${w}&nbsp;(${cnymd(_i[2])}制作)
		<br>
		源站地址：<a style="text-decoration:underline" href="https://lchzh3473.github.io/sim-phi">sim-phi</a>
		<br>
		镜像站作者：<a style="text-decoration:underline" href="https://github.com/FoxSuzuran">铃兰</a>
		<br>
		最后更新于${cnymd(_i[3])}`;
